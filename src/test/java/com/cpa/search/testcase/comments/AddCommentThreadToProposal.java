...
public class AddCommentThreadToProposal extends BootStrap {
    ...
    public void publishProposal() {
        ...
        String strBody3 = "{\n" +
                ...
                "  ]\n" +
                "}";
        setResponse(baseURI + "api/projects/" + projectId + "/publish", "POST", strBody3);
    }
    @Test(priority = 1)
    public void addCommentThreadToProposal_NulL_Request_500() {
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
                "}";
    ...
    @Test(priority = 2)
    public void addCommentThreadToProposal_InvalidProposalId_404() {
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
                "  \"comment\": {\n" +
                ...
                "}";
        validateStatusCode(baseURI + "api/projects/" + projectId + "/proposals/" + proposalId + "sdsd/comments/threads", strBody, 404, "POST");
    }
    @Test(priority = 3)
    public void addCommentThreadToProposal_200() {
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
                "  \"comment\": {\n" +
    ...
    @Test(priority = 4)
    public void addCommentThreadToProposal_ResponseMessage() {
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
                "  \"comment\": {\n" +
