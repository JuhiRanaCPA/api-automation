...
public class PostDeclineProposalByProposalId extends BootStrap{
    LocalDateTime currentDateTime = LocalDateTime.now();
     ...
     public void addProjectAndProposal(){
         ...
         proposalId= getValueFromResponse(baseURI + "api/projects/"+projectId+"/proposals",strBody1,"id","POST");
          apiUrl =apiUrl+projectId+"/proposals/"+proposalId+"/decline";
     }
    @Test(priority = 1)
    public void postDeclineProposalByProposalId_UnpublishedProject_500() {
    ...
    //    @Test(priority = 2)
//    public void postDeclineProposalByProposalId_UnpublishedProject_ResponseMessage() {
//        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
//        String strBody ="{\n" +
//                "  \"content\": \"Un publishing proposal as needs some changes in pricing\"\n" +
//                "}";
...
//    }
    @Test(priority = 3)
    public void postDeclineProposalByProposalId_Accept_PublishedProject_200() {
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
    ...
    @Test(priority = 4)
    public void postDeclineProposalByProposalId_ResponseTime() {
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String strBody ="{\n" +
                "  \"content\": \"Un publishing proposal as needs some changes in pricing\"\n" +
                "}";
