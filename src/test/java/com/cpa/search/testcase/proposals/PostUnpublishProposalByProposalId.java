...
public class PostUnpublishProposalByProposalId extends BootStrap{
    String projectId,proposalId = "";
     String apiUrl = baseURI + "api/projects/";

    @BeforeTest
    public void addProjectAndProposal() throws InterruptedException {
        ...
        apiUrl =apiUrl+projectId+"/proposals/"+proposalId+"/unpublish";
    }
    @Test(priority = 1)
    public void postUnpublishProposalByProposalId_Unpublish_UnpublishedProejct_400() {
    ...
    @Test(priority = 2)
    public void postUnpublishProposalByProposalId_Unpublish_UnpublishedProejct_ResponseMessage() {
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String strBody ="{\n" +
                "  \"content\": \"Un publishing proposal as needs some changes in pricing\"\n" +
                "}";
    ...
    @Test(priority = 3)
    public void postUnpublishProposalByProposalId_Unpublish_PublishedProject_200() throws InterruptedException {
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
    ...
    @Test(priority = 4)
    public void postUnpublishProposalByProposalId_ResponseTime() {
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String strBody ="{\n" +
                "  \"content\": \"Un publishing proposal as needs some changes in pricing\"\n" +
                "}";
