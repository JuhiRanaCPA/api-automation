...
public class PostProjectSearch extends BootStrap{

    String apiUrl = baseURI + "api/projects/search";
    @Test(priority = 1)
    public void postProjectSearch_ValidRequest_Status_Code(){
    ...
    @Test(priority = 5)
    public void postProjectSearch_ClientName_200(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String projectCaseNo = this.getClass().getSimpleName() + generateRandom(5);
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
    ...
    @Test(priority = 6)
    public void postProjectSearch_ClientName_Response_Message(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String extepectedstatus ="Pass";
        String finalStatus = "";
    ...
    @Test(priority = 7)
    public void postProjectSearch_NullClientName_Status_Code(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String projectCaseNo = this.getClass().getSimpleName() + generateRandom(5);
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
    ...
    @Test(priority = 8)
    public void postProjectSearch_Null_ClientName_Response_Message(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String extepectedstatus ="Pass";
        String finalStatus = "Fail";
        String projectCaseNo = this.getClass().getSimpleName() + generateRandom(5);
...
//    }
       ...
       @Test(priority = 13)
    public void postProjectSearch_Invalid_PrenegotiatedProject_400(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String strBody = "{\n" +
                "  \"filter\": {\n" +
                "    \"caseOrMatterNumber\": \"\",\n" +
...
//    @Test(priority = 14)
//    public void postProjectSearch_InValid_PrenegotiatedProject_Response_Message() {
//        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
//        String strBody = "{\n" +
//                "  \"filter\": {\n" +
//                "    \"caseOrMatterNumber\": \"\",\n" +
...
//    }
    ...
    @Test(priority = 15)
    public void postProjectSearch_StartDate_200(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String projectCaseNo = this.getClass().getSimpleName() + generateRandom(5);
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
    ...
    @Test(priority = 16)
    public void postProjectSearch_StartDate_Response_Message(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String extepectedstatus ="Pass";
        String finalStatus = "Fail";
        String date = getCurrentDate("yyyy-MM-dd");
    ...
    @Test(priority = 17)
    public void postProjectSearch_Invalid_StartDate_400(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
                "  \"filter\": {\n" +
...
//    @Test(priority = 18)
//    public void postProjectSearch_InValid_StartDate_Response_Message() {
//        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
//        String date = getCurrentDate("yyyy-MM-dd");
//        String strBody = "{\n" +
//                "  \"filter\": {\n" +
...
//    }
    ...
    @Test(priority = 19)
    public void postProjectSearch_DeliveryDate_200(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String projectCaseNo = this.getClass().getSimpleName() + generateRandom(5);
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
    ...
    @Test(priority = 20)
    public void postProjectSearch_DeliveryDate_Response_Message(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String extepectedstatus ="Pass";
        String finalStatus = "Fail";
        String date = getCurrentDate("yyyy-MM-dd");
    ...
    @Test(priority = 21)
    public void postProjectSearch_Invalid_DeliveryDate_400(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
                "  \"filter\": {\n" +
...
//    @Test(priority = 22)
//    public void postProjectSearch_InValid_DeliveryDate_Response_Message() {
//        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
//      String date = getCurrentDate("yyyy-MM-dd");
//        String strBody = "{\n" +
//                "  \"filter\": {\n" +
...
//    }
    ...
    @Test(priority = 23)
    public void postProjectSearch_LastUpdated_200(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String projectCaseNo = this.getClass().getSimpleName() + generateRandom(5);
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
    ...
    @Test(priority = 24)
    public void postProjectSearch_LastUpdated_Response_Message(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String extepectedstatus ="Pass";
        String finalStatus = "Fail";
        String date = getCurrentDate("yyyy-MM-dd");
    ...
    @Test(priority = 25)
    public void postProjectSearch_Invalid_LastUpdated_400(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
                "  \"filter\": {\n" +
...
//    @Test(priority = 26)
//    public void postProjectSearch_InValid_LastUpdated_Response_Message() {
//        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
//        String date = getCurrentDate("yyyy-MM-dd");
//        String strBody = "{\n" +
//                "  \"filter\": {\n" +
...
//    }
    ...
    @Test(priority = 29)
    public void postProjectSearch_InValid_Status_LastUpdated_400(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
          String strBody = "{\n" +
                "  \"filter\": {\n" +
                "    \"caseOrMatterNumber\": \"\",\n" +
...
//    }
    @Test(priority = 31)
    public void postProjectSearch_LatestDocument_200(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
    ...
    @Test(priority = 32)
    public void postProjectSearch_LatestDocument_Response_Message(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String extepectedstatus ="Pass";
        String finalStatus = "";
        String lastDocument ="proposal";
    ...
    @Test(priority = 33)
    public void postProjectSearch_InValid_LatestDocument_LastUpdated_400(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String strBody = "{\n" +
                "  \"filter\": {\n" +
                "    \"caseOrMatterNumber\": \"\",\n" +
...
//    @Test(priority = 34)
//    public void postProjectSearch_InValid_LatestDocument_Response_Message() {
//        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
//        String strBody = "{\n" +
//                "  \"filter\": {\n" +
//                "    \"caseOrMatterNumber\": \"\",\n" +
...
//    }
    ...
    @Test(priority = 35)
    public void postProjectSearch_OrderBy_200(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String projectCaseNo = this.getClass().getSimpleName() + generateRandom(5);
        String strBody = "{\n" +
                "  \"filter\": {\n" +
    ...
    @Test(priority = 36)
    public void postProjectSearch_OrderBy_Response_Message(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String extepectedstatus ="Pass";
        String finalStatus = "Fail";
        String strBody = "{\n" +
    ...
    @Test(priority = 37)
    public void postProjectSearch_InValid_OrderBy_LastUpdated_400(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String strBody = "{\n" +
                "  \"filter\": {\n" +
                "    \"caseOrMatterNumber\": \"\",\n" +
...
//    @Test(priority = 38)
//    public void postProjectSearch_InValid_OrderBy_Response_Message() {
//        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
//        String strBody = "{\n" +
//                "  \"filter\": {\n" +
//                "    \"caseOrMatterNumber\": \"\",\n" +
...
//    }
    ...
    @Test(priority = 39)
    public void postProjectSearch_OrderDirection_200(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String projectCaseNo = this.getClass().getSimpleName() + generateRandom(5);
        String strBody = "{\n" +
                "  \"filter\": {\n" +
    ...
    @Test(priority = 40)
    public void postProjectSearch_OrderDirection_Response_Message(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String extepectedstatus ="Pass";
        String finalStatus = "Fail";
        String strBody = "{\n" +
    ...
    @Test(priority = 41)
    public void postProjectSearch_InValid_OrderDirection_LastUpdated_400(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String strBody = "{\n" +
                "  \"filter\": {\n" +
                "    \"caseOrMatterNumber\": \"\",\n" +
...
//    @Test(priority = 42)
//    public void postProjectSearch_InValid_OrderDirection_Response_Message() {
//        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
//        String strBody = "{\n" +
//                "  \"filter\": {\n" +
//                "    \"caseOrMatterNumber\": \"\",\n" +
...
//    }
    ...
    @Test(priority = 43)
    public void postProjectSearch_ResponseTime(){
        log.info("<====================" + Thread.currentThread().getStackTrace()[1].getMethodName() + "====================>");
        String projectCaseNo = this.getClass().getSimpleName() + generateRandom(5);
        String date = getCurrentDate("yyyy-MM-dd");
        String strBody = "{\n" +
